...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'localhost'),  # Cambiar de 'mysql' a 'localhost'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [],  # Vacío para que no use autenticación de DRF
